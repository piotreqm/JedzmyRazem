    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Travelers", t => t.FriendId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        TravelerId = c.Long(nullable: false),
                        Time = c.DateTime(nullable: false),
                        StartPlace = c.String(nullable: false),
                        EndPlace = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Travelers", t => t.TravelerId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Information", "TravelerId", "dbo.Travelers");
            DropForeignKey("dbo.FriendLists", "OwnerId", "dbo.Travelers");
            DropForeignKey("dbo.FriendLists", "FriendId", "dbo.Travelers");
            ...
            DropIndex("dbo.Information", new[] { "TravelerId" });
